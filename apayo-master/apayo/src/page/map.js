...
const Map=({keyword}) => {
  ...
  useEffect(() => {
    ...
    searchPlaces("서울특별시 강남구 양재동"+keyword, map); // 설정한 키워드로 검색
    //여기까지
    ...
    //         console.log("현재주서:",currentAddress)
    //         //currentAddress: 서울특별시 강남구 양재동
    //       }
    //     });
    //   });
